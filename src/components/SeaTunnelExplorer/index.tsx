    ...
    >
      ...
      <div className="h-10 flex items-center justify-between px-3 border-b border-border-default flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-foreground-default">{t('seaTunnel.title')}</span>
        </div>
        <div className="flex items-center space-x-2 text-foreground-muted">
          <Tooltip content={t('seaTunnel.refresh')}>
            <RefreshCw
              size={16}
              className="cursor-pointer hover:text-foreground-default transition-colors"
              onClick={() => init()}
            />
          </Tooltip>
          <Tooltip content={t('seaTunnel.newConnection')}>
            <div
              className="flex items-center gap-0.5 cursor-pointer hover:text-foreground-default transition-colors"
