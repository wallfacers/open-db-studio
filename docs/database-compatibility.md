...
| 功能维度 | MySQL | PostgreSQL | Oracle | SQL Server | SQLite | Apache Doris | ClickHouse | TiDB |
|----------|:-----:|:----------:|:------:|:----------:|:------:|:------------:|:----------:|:----:|
...
| **表 DDL 查看** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| **数据库统计信息** | ✅ | ✅ | ✅ | ✅ | ⚠️ | ✅ | ✅ | ✅ |
| **AI SQL 生成（SQL 方言）** | ✅ Standard | ✅ Standard | ✅ Standard | ✅ Standard | ✅ Standard | ✅ Doris | ✅ ClickHouse | ✅ Standard |
...
| 数据库 | 说明 |
|--------|------|
| MySQL / PostgreSQL / Oracle / SQL Server / TiDB | ✅ 完整支持，可查看索引名称、类型、列信息 |
...
| 数据库 | 说明 |
|--------|------|
| MySQL / PostgreSQL / Oracle / SQL Server / TiDB | ✅ 完整支持，GraphRAG 可通过外键自动推断 JOIN 路径 |
...
| 数据库 | 说明 |
|--------|------|
| MySQL / PostgreSQL / Oracle / SQL Server | ✅ 完整支持，可在 DBTree 中查看、DBTree 右键菜单可执行 |
...
| 数据库 | 说明 |
|--------|------|
| MySQL / PostgreSQL / Oracle / SQL Server | ✅ 完整支持 |
...
| 数据库 | 说明 |
|--------|------|
| MySQL / PostgreSQL / Oracle / SQL Server / Apache Doris / ClickHouse / TiDB | ✅ 支持在同一连接下切换数据库，DBTree 展示数据库列表 |
...
| MySQL | 3306 | — |
| PostgreSQL | 5432 | — |
| Oracle | 1521 | 需 Oracle Instant Client |
