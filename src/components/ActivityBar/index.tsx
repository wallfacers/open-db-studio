...
import { User, Database, LayoutDashboard, MessageSquare, LayoutGrid, ListTodo, BarChart2, GitBranch, RefreshCw, Bell, Settings, ChevronRight, ChevronLeft } from 'lucide-react';
